...
<tr valign="top">
	<th scope="row"><label for="super_cache_enabled"><?php esc_html_e( 'Cache Delivery Method', 'wp-super-cache' ); ?></label></th>
	<td>
		<fieldset>
...
<tr valign="top">
	<th scope="row"><label for="wp_cache_status"><?php esc_html_e( 'Advanced', 'wp-super-cache' ); ?></label></th>
	<td>
		<fieldset>
...
echo '<tr><td valign="top"><strong>' . esc_html__( 'Scheduler', 'wp-super-cache' ) . '</strong></td><td><table cellpadding=0 cellspacing=0><tr><td valign="top"><input type="radio" id="schedule_interval" name="cache_schedule_type" value="interval" ' . checked( 'interval', $cache_schedule_type, false ) . ' /></td><td valign="top"><label for="cache_interval_time">' . esc_html__( 'Timer:', 'wp-super-cache' ) . '</label></td>';
echo "<td><input type='text' id='cache_interval_time' size=6 name='cache_time_interval' value='" . esc_attr( $cache_time_interval ) . "' /> " . esc_html__( "seconds", 'wp-super-cache' ) . '<br />' . esc_html__( 'Check for stale cached files every <em>interval</em> seconds.', 'wp-super-cache' ) . "</td></tr>";
