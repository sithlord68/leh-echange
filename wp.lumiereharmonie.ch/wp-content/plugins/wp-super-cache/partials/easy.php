		...
		<?php
			echo \wp_kses(
				\printf(
					...
					esc_url( $wpsc_promo_links['jetpack'] )
				),
				'a'
			);
			?>
...
<li><?php printf( esc_html__( '<strong>Advanced users only:</strong> Install an object cache. Choose from <a href="%s">Memcached</a>, <a href="%s">XCache</a>, <a href="%s">eAcccelerator</a> and others.', 'wp-super-cache' ), 'https://wordpress.org/plugins/memcached/', 'https://neosmart.net/WP/XCache/', 'https://neosmart.net/WP/eAccelerator/' ); ?></li>
...
<p><?php esc_html_e( "* The links above (apart from Jetpack) go to websites outside the author's control. Caution is advised when testing any new software.", 'wp-super-cache' ); ?></p>
